...
var stripe = require('stripe')("sk_test_69qIQ4etAnofSMXMYO6cgwHh");
...
app.get("/", function (req, res) {
  res.render("index.ejs", { clientKey: "pk_test_IiRstes0vA8UDPkuLdrPhafQ", amountToCharge: amountToCharge });
});
